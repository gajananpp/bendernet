...
export const Thread: FC = () => {
	return (
		...
		>
			{/* aui-thread-viewport */}
			<ThreadPrimitive.Viewport className="relative flex min-w-0 flex-1 flex-col gap-6 overflow-y-scroll mt-10">
				<ThreadWelcome />
			...
			<div className="mx-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col px-[var(--thread-padding-x)]">
				...
				<div className="flex w-full flex-grow flex-col items-center justify-center">
					...
					<div className="flex size-full flex-col justify-center px-8 md:mt-20">
						...
						>
							How can Bender assist your puny human needs today?
						</motion.div>
					</div>
				</div>
			</div>
			...
			{[
				{
					...
					action: "Show me all electronics products",
				},
				{
					title: "Find products with",
					label: `price greater than $50`,
					action: `Find products with price greater than 50`,
				},
				{
					title: "Show name and stock",
					label: `for active products`,
					action: `Show name and stock for active products`,
				},
				{
					title: "What products are",
					label: "out of stock?",
					action: "What products are out of stock?",
				},
